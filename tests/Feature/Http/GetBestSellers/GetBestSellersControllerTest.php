...
class GetBestSellersControllerTest extends TestCase
{
    ...
    {
        $url = self::ENDPOINT_URL . '?author=Isaac&isbn[]=0553293389&isbn[]=9780553293388&title=Whatever&offset=20';
    ...
    {
        $url = self::ENDPOINT_URL . '?isbn[]=055329338&isbn[]=97805532933888&offset=10';
